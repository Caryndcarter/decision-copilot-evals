...
| --- | --- | --- |
| Scenario: Civitas (starved) | `db9445cf-ef02-5740-b69f-d34a1194e04a` | `civitas-replication` (do not retag) |
...
- **Civitas (starved):** Standard self-credit high on T1–T5. Blind self-credit high on T1–T4, medium on T5 (only open→blind self drop). Standard often compresses peers (Gemini low/minimal on 3 of 5 trials).
...
- Starved contribution analyses inferred at **4096** tokens (then-current client/lens default). Current lens: OpenAI synthesizer 8192, others 16384.
- Starved think-tank models: gpt-5.5, claude-sonnet-4-6, gemini-3.6-flash, grok-4.3.
