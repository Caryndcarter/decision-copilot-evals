  ...
  },
  {
    ...
    findings: [
      ...
      },
      {
        ...
        body: "On the five-demo adequate-budget (Sol) control — including the Civitas demo — ChatGPT as rater scored self high under both Standard and Blind. No open→blind self drop.",
      },
    ],
    methodology: [
