  ...
  return (
    ...
    {tab === "harness" && harnessGroups.length > 0 && (
      <p className="mb-4 text-sm text-zinc-500">
        Civitas stress-harness trials from <code className="text-xs">npm run harness:civitas</code>.
        Same case inputs; separate Unified Briefs and influence charts per trial.
      </p>
    )}
